    ...
    if (isset($_POST['checkOutDetails'])) {
        if (mysqli_num_rows($query) > 0) {
            ...
            if (!isset($_SESSION['uid'])) {
                ...
                echo
                    '<input type="hidden" name="return" value="http://localhost/OnlineStore/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/OnlineStore/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/OnlineStore/cancel.php"/>
